...
const LowerFooter = () => {
  ...
  return (
    <div className={`w-full flex flex-row flex-wrap xl:flex-nowrap gap-8 xl:gap-0 justify-between items-start py-4 ${theme === 'light' ? 'text-darkBlue1x' : 'text-white'} text-xs sm:text-sm`}>
