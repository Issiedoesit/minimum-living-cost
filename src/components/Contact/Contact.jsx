  ...
  return (
    <section className='h-screen relative'>
      ...
      <div className='flex flex-col items-center justify-center h-full z-0 px-10'>
        <div className='inter text-center text-red1x/60 relative -z-100'>
           <FontAwesomeIcon icon={faPhoneFlip} className="text-red1x animate-wiggle give-z-10" size='7x'/>
          </div>
          <div className='inter text-center text-red1x/60 py-10 space-y-10'>
            <h1 className='inter-700 text-3xl'>Contact</h1>
            <p>Coming Soon</p>
          </div>
     </div>
    </section>
