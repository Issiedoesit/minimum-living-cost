...
const ListCards = (props) => {
  return (
    <div key={props.id} id={props.id} className="dm shadow-lg rounded-26.62px max-w-[300px] sm:max-w-[350px] hover:scale-90 transition-transform ease-in-out duration-500 mx-auto">
      <div>
