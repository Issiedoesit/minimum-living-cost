...
function onYouTubeIframeAPIReady() {
    ...
    const controlVideo = () =>{
        isPlaying ?  $('.youtube-video')[0].contentWindow.postMessage('{"event":"command","func":"' + 'playVideo' + '","args":""}', '*') : $('.youtube-video')[0].contentWindow.postMessage('{"event":"command","func":"' + 'stopVideo' + '","args":""}', '*')
    ...
    <main className='relative w-full bg-red1x/10 pb-10 xl:pb-0'>
      <section className="grid grid-col-1 lg:grid-cols-2 auto-rows-fr auto-cols-fr">
            ...
            <section className='col-span-1 px-4 min-h-full pt-3 relative group'>
                        ...
                        <iframe  className='youtube-video w-full min-h-full' src="https://www.youtube.com/embed/pkwTpdpB8do" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
