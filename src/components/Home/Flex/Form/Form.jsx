            ...
            <section className='flex flex-col sm:grid sm:grid-cols-2 lg:grid-cols-3 pt-8 sm:pt-16 gap-4 sm:gap-10'>
                ...
                <div className='flex flex-col gap-4 items-start col-span-1'>
                    ...
                    <label htmlFor="city" className='relative w-full'>
                        <select  name="city" id="city" className='peer focus:outline-red1x border border-lightGrey1x h-12 focus-within:placeholder:text-transparent rounded-five inter inter-400 text-sm text-grey4x bg-lightGrey2x px-5 py-3 w-full min-h-fit'>
                ...
                <div className='flex flex-col gap-4 items-start col-span-1'>
                    ...
                    <label htmlFor="state" className='relative w-full'>
                        <select  name="state" id="state" className='peer focus:outline-red1x border border-lightGrey1x h-12 focus-within:placeholder:text-transparent rounded-five inter inter-400 text-sm text-grey4x bg-lightGrey2x px-5 py-3 w-full min-h-fit'>
